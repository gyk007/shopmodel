...
class ControllerAffiliatePayment extends Controller {
	...
	public function index() {
        ...
        $summ = $this->model_affiliate_affiliate->getTotalTransactions($this->affiliate->getId());
        
        if (isset($this->request->post['summ'])) {
    		$this->data['summ'] = $this->request->post['summ'];
		} elseif (!empty($affiliate_info)) {
			$this->data['summ'] = (int)$summ;		
		} else {
			$this->data['summ'] = '';
		}
		 if (isset($this->request->post['prim'])) {
    		$this->data['prim'] = $this->request->post['prim'];
		}  else {
			$this->data['prim'] = '';
		}
