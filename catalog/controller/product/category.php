	...
	public function index() { 
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
                ...
                $set1 = $this->config->get('config_image_product_width') + 200; // Ширина зум изображения основного фото
                $set2 = $this->config->get('config_image_product_height')/$this->config->get('config_image_product_width')*$set1; // Высота зум изображения основного фото
				...
				$set3 = $this->config->get('config_image_product_width') + 272; // Ширина зум изображения дополнительных фото
                $set4 = $this->config->get('config_image_product_height')/$this->config->get('config_image_product_width')*$set3; // Высота зум изображения дополнительных фото
				...
				foreach ($imgs as $imgi) {
					$imgt[] = array(
						...
						'thumb1' => $this->model_tool_image->resize($imgi['image'], $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height')), // Ресайз дополнительного зум изображения при клике на иконку дополнительного изображения
						'thumb2' => $this->model_tool_image->resize($imgi['image'], $set3, $set4)  // Ресайз дополнительного зум изображения товара при наведении
					);
				}
