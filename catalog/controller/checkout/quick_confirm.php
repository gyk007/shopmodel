<?php 
class ControllerCheckoutQuickConfirm extends Controller { 
	public function index() {
		...
		if ($this->data['not_address_quick_registration_checkout']) {
			if ($this->cart->hasShipping()) {
				...
				if (empty($shipping_address)) {								
					$redirect = $this->url->link('checkout/quick_checkout', '', 'SSL');
				}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/quick_confirm.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/quick_confirm.tpl';
		} else {
			$this->template = 'default/template/checkout/quick_confirm.tpl';
		}
