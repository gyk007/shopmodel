<?php 
class ControllerCheckoutQuickRegister extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/quick_register.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/quick_register.tpl';
		} else {
			$this->template = 'default/template/checkout/quick_register.tpl';
		}
