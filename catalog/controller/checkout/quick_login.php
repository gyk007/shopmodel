<?php  
class ControllerCheckoutQuickLogin extends Controller { 
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/quick_login.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/quick_login.tpl';
		} else {
			$this->template = 'default/template/checkout/quick_login.tpl';
		}
