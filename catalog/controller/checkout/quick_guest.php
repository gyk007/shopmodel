<?php 
class ControllerCheckoutQuickGuest extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/quick_guest.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/quick_guest.tpl';
		} else {
			$this->template = 'default/template/checkout/quick_guest.tpl';
		}
