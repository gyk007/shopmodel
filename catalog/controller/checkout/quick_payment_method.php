<?php  
class ControllerCheckoutQuickPaymentMethod extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/quick_payment_method.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/quick_payment_method.tpl';
		} else {
			$this->template = 'default/template/checkout/quick_payment_method.tpl';
		}
