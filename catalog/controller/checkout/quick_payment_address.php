<?php 
class ControllerCheckoutQuickPaymentAddress extends Controller {
	public function index() {
		$this->language->load('checkout/quick_checkout');
		
		$this->data['text_address_existing'] = $this->language->get('text_address_existing');
		$this->data['text_checkout_address_not'] = $this->language->get('text_checkout_address_not');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/quick_payment_address.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/quick_payment_address.tpl';
		} else {
			$this->template = 'default/template/checkout/quick_payment_address.tpl';
		}
