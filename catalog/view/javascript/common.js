//function mysale(){
//    $('#mysaleimg').animate({opacity: 0.8},300,function(){
//         $('#mysaleimg').attr('src', 'mysaleactiv.jpg');});
//         $('#mysaleimg').animate({opacity: 1},300,function(){
//         $('#mysaleimg').attr('src', 'mysale.jpg');});
//}
...
$(document).ready(function() {
    ...
    /*mysale*/
     //  var intervalID;
   // $('#mysaleimg').mouseenter(function(){
        
      //intervalID = setInterval('mysale()',700);  
      
      //});   
    
 
//$('#mysaleimg').mouseleave(function(){
