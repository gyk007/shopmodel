var arrow_enabled = 25; // 0 выключить стрелочку вверх
...
function getNextPage() {
    ...
    $(container).append('<div id="ajaxblock" style="background-color: #FFF !important; width:'+w+'px;height:30px;margin-top:20px;text-align:center;border:none !important;"><img src="/image/loader.gif" /></div>');
