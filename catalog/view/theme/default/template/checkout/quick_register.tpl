<div class="left">
  ...
  <?php if ($first_quick_registration_checkout) { ?>
  ...
  <?php } ?>
  <?php if ($last_quick_registration_checkout) { ?>
  ...
  <br />
  <br />
  <?php if ($telephone_quick_registration_checkout) { ?>
  ...
  <?php } ?>
  <?php if ($fax_quick_registration_checkout) { ?>
...
<div class="right">
  ...
  <?php if ($company_quick_registration_checkout) { ?>
  ...
  <?php } ?>
  <?php if ($customer_groups_quick_registration_checkout) { ?>
  ...
  <?php } ?>
  <?php if ($address_1_quick_registration_checkout) { ?>
  ...
  <?php } ?>
  <?php if ($address_2_quick_registration_checkout) { ?>
  ...
  <?php } ?>
  <?php if ($city_quick_registration_checkout) { ?>
  ...
  <?php } ?>
  <?php if ($post_code_quick_registration_checkout) { ?>
  ...
  <?php } ?>
  <?php if ($country_quick_registration_checkout) { ?>
...
<?php } ?>
<?php if ($subscribe_quick_registration_checkout) { ?>
...
<?php if ($text_agree) { ?>
<div class="buttons">
  <div class="agree"><?php echo $text_agree; ?>
...
$('#payment-address select[name=\'country_id\']').bind('change', function() {
	...
	$.ajax({
		url: 'index.php?route=checkout/quick_checkout/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
