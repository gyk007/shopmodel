...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="checkout">
    ...
    <?php } else { ?>
	  <?php if ($not_address_quick_registration_checkout) { ?>
		<div id="payment-address">
...
$('#checkout .checkout-content input[name=\'account\']').live('change', function() {
	if ($(this).attr('value') == 'quick_register') {
...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_login',
		dataType: 'html',
...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_payment_address',
		dataType: 'html',
		success: function(html) {
...
$('#button-login').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_login/validate',
		type: 'post',
...
$('#button-register').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_register/validate',
		type: 'post',
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (shipping_address) {
					$.ajax({
						url: 'index.php?route=checkout/quick_shipping_method',
						dataType: 'html',
						success: function(html) {
							...
							$.ajax({
								url: 'index.php?route=checkout/quick_shipping_address',
								dataType: 'html',
								success: function(html) {
				...
				<?php } else { ?>
				$.ajax({
					url: 'index.php?route=checkout/quick_payment_method',
					dataType: 'html',
					success: function(html) {
...
$('#button-payment-address').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_payment_address/validate',
		type: 'post',
		data: $('#payment-address input[type=\'text\'], #payment-address input[type=\'password\'], #payment-address input[type=\'checkbox\']:checked, #payment-address input[type=\'radio\']:checked, #payment-address input[type=\'hidden\'], #payment-address select'),
		dataType: 'json',
		beforeSend: function() {
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_shipping_address/validate',
		type: 'post',
...
$('#button-guest').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_guest/validate',
		type: 'post',
				...
				if (shipping_address) {
					$.ajax({
						...
						success: function(html) {
							...
							$.ajax({
								url: 'index.php?route=checkout/quick_guest_shipping',
								dataType: 'html',
								success: function(html) {
									$('#shipping-address .checkout-content').html(html);
								},
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_guest_shipping/validate',
		type: 'post',
...
$('#button-shipping-method').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_shipping_method/validate',
		type: 'post',
...
$('#button-payment-method').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/quick_payment_method/validate', 
		type: 'post',
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				$.ajax({
					url: 'index.php?route=checkout/quick_confirm',
					dataType: 'html',
					success: function(html) {
