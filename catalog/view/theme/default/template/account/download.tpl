  ...
  <div class="download-list">
    ...
    <div class="download-content">
      ...
      <div class="download-info">
        ...
        <a href="<?php echo $download['href']; ?>"><img src="catalog/view/theme/default/image/icon/order-download-icon.png" alt="<?php echo $button_download; ?>" class="poshytips" title="<?php echo $button_download; ?>" /></a>
        <?php } ?>
      </div>
    </div>
  </div>
