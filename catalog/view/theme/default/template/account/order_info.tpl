  ...
  <table class="list">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="right"><a href="<?php echo $product['return']; ?>"><img align="absmiddle" src="catalog/view/theme/default/image/icon/order-return.png" class="poshytips" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
      </tr>
      <?php } ?>
