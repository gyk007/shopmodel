...
function addModule() {	
	...
	html += '    <td class="left"><input type="text" name="special_module[' + module_row + '][image_width]" value="220" size="3" /> <input type="text" name="special_module[' + module_row + '][image_height]" value="220" size="3" /></td>';
