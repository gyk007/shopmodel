		...
		<table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
			  ...
			  <td class="left"><input type="text" name="category_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" size="3" />
                <input type="text" name="category_module[<?php echo $module_row; ?>][image_height]" value="<?php echo $module['image_height']; ?>" size="3" />
...
function addModule() {	
	...
	html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="category_module[' + module_row + '][image_width]" value="80" size="3" /> <input type="text" name="category_module[' + module_row + '][image_height]" value="80" size="3" /></td>'; 
