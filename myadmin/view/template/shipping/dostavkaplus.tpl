                ...
                <div id="tab-general" class="vtabs-content">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="<?php echo $name; ?>_show_error_text" value="1" <?php if (${$name.'_show_error_text'}) { ?>checked="checked"<?php } ?> /></td>
                        </tr>
                        <tr>
                ...
                <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="<?php echo $name; ?>_module[<?php echo $module_row; ?>][price]" value="<?php if (isset($module['price'])) echo $module['price']; ?>" size="5" /></td>
                        </tr>
