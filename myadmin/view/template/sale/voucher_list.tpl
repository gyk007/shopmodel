        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-status" id="status-<?php echo $voucher['voucher_id']; ?>"><?php echo $voucher['status']; ?></a></td>
			  <td class="right">
...
$('.ajax-status').click(function() {
	...
	$.ajax({
		url: 'index.php?route=sale/voucher/changeStatus&token=<?php echo $token; ?>',
		type: 'get',
