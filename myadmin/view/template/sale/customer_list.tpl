        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-status" id="status-<?php echo $customer['customer_id']; ?>"><?php echo $customer['status']; ?></a></td>
              <td class="center">
...
$('.ajax-status').click(function() {
	...
	$.ajax({
		url: 'index.php?route=sale/customer/changeStatus&token=<?php echo $token; ?>',
		type: 'get',
