        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo  $affiliate['count']; ?></td>
              ...
              <?php $countBalance = $countBalance + $affiliate['balance'];  ?>
              <td class="center">
          ...
          <?php  echo "<b style ='text-align: center; font-size: 20px;'> Всего к выплате: ".$countBalance."$</b>"; ?>
        </table>
      </form>
