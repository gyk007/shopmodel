	  ...
	  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<table class="form">
		  <tr>
			...
			<td><input type="text" name="interkassa_merchant" value="<?php echo $interkassa_merchant; ?>"/>
		  ...
		  <tr>
			...
			<td><input type="text" name="interkassa_security" value="<?php echo $interkassa_security; ?>"/>
		  ...
		  <tr>
			...
			<td><select name="interkassa_status">
		  ...
		  <tr>
			...
			<td><select name="interkassa_order_status_id">
			  <?php foreach ($order_statuses as $order_status) { ?>
			  <?php if ($order_status['order_status_id'] == $interkassa_order_status_id) { ?>
