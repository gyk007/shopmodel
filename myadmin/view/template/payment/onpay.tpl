	...
	<div class="content">
	  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<table class="form">
		  ...
		  <tr>
			<td><?php echo $entry_add_params; ?><a target="_blank" href="http://wiki.onpay.ru/doku.php?id=payment-links-specs"> <?php echo $text_help?></a></td>
			<td><input type="text" name="onpay_add_params" value="<?php echo $onpay_add_params; ?>"/></td>
		  </tr>
		  <tr>
