...
<script type="text/javascript" src="view/javascript/ckeditor/ckeditor.js"></script> 
  ...
  <div class="paginationtop"><?php echo $pagination; ?></div>
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td width="100" class="left"><?php if ($sort == 'pd.name') { ?>
          ...
          <tbody>
            <tr class="filter">
              <td></td>
              <td></td>
              <td><input type="text" name="filter_name" value="<?php echo $filter_name; ?>" size="20" /></td>
              
               <td width = '20'><select name="filter_manufacturer" onchange="filter(); "   >
                  <option value="*"></option>                   
		  ...
		  <?php }?>
              ...
              <td width = '20'><input type="text" name="filter_model" value="<?php echo $filter_model; ?>" size="10" /></td>
              <td align="right" width = '20'><input type="text" name="filter_price" value="<?php echo $filter_price; ?>" size="15"/></td>
              <td align="right" width = '20'><input type="text" name="filter_quantity" value="<?php echo $filter_quantity; ?>" style="text-align: right;"  size="12" /></td>
              <td align="center">
				...
				<tr>
				  ...
				  <td class="left">
					...
					<span><?php echo $product['name']; ?></span></td>
                     ...
                     <td class="left">				 
						<?php echo $product['manufacturer'][0];?> 				   
				        </td>  
