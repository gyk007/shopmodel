...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/information.png" alt="" /> <?php echo $heading_title; ?><span class="information_title"></span></h1>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="information_description[<?php echo $language['language_id']; ?>][title]" size="103" value="<?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['title'] : ''; ?>" />
...
//--></script>
<script type="text/javascript"><!--
$information_title = $('input[name="information_description[<?php echo $this->config->get('config_language_id'); ?>][title]"]'); 
$title = $('.information_title');

if ($information_title.val() != '') {
	$title.html(' - ' + $information_title.val()); 
}
