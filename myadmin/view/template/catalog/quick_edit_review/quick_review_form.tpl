      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="author" value="<?php echo $author; ?>" size="103" />
              <?php if ($error_author) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="product" value="<?php echo $product; ?>" size="103" />
          ...
          <tr>
            ...
            <td><textarea name="text" cols="100" rows="8"><?php echo $text; ?></textarea>
              <?php if ($error_text) { ?>
