          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><input type="text" name="category_description[<?php echo $language['language_id']; ?>][seo_h1]" size="103" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['seo_h1'] : ''; ?>" /></td>
              </tr>
              <tr>
                <td><?php echo $entry_seo_title; ?></td>
                <td><input type="text" name="category_description[<?php echo $language['language_id']; ?>][seo_title]" size="103" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['seo_title'] : ''; ?>" /></td>
              </tr>
              <tr>
            ...
            <tr>
              ...
              <td><div class="scrollbox">
                  ...
                  <div class="<?php echo $class; ?>">  
                    ...
                    <label><input type="radio" name="variant" value="0" <?php if($variant['variant'] == 0){?>checked="checked"<?php } ?> /> Женская одежда</label></br>
                    <label><input type="radio" name="variant" value="1" <?php if($variant['variant'] == 1){?>checked="checked"<?php } ?>  /> Детская одежда</label></br>
                    <label><input type="radio" name="variant" value="2"  <?php if($variant['variant'] == 2){?>checked="checked"<?php } ?> /> Мужская одежда</label></br>
