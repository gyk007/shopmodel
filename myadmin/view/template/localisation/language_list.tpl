        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-status" id="status-<?php echo $language['language_id']; ?>"><?php echo $language['status']; ?></a></td>
...
$('.ajax-status').click(function() {
	...
	$.ajax({
		url: 'index.php?route=localisation/language/changeStatus&token=<?php echo $token; ?>',
		type: 'get',
