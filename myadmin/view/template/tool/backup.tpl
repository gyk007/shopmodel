        ...
        <table class="form">
          <tr>
            ...
            <td><div class="scrollbox" style="margin-bottom: 5px; height: 250px;">
              ...
              <a onclick="$(this).parent().find(':checkbox').attr('checked', true);" class="button"><?php echo $text_select_all; ?></a> <a onclick="$(this).parent().find(':checkbox').attr('checked', false);" class="button"><?php echo $text_unselect_all; ?></a></td>
          </tr>
        </table>
      </form>
    </div>
