...
$_['button_install']     			= '<span class="button_install tooltip" title="Установить"></span>';
$_['button_uninstall']   			= '<span class="button_uninstall tooltip" title="Удалить"></span>';
$_['button_view']   				= '<span class="button_view tooltip" title="Просмотр"></span>';
...
$_['button_add_transaction']        = 'Добавить операцию';
...
$_['tab_return']                    = 'Детали возвратов';
$_['tab_reward']                    = 'Бонусные баллы';
$_['tab_shipping']                  = 'Адрес доставки';
$_['tab_total']                     = 'Итого';
$_['tab_transaction']               = 'Финансовые операции';
$_['tab_voucher']                   = 'Подарочные сертификаты';
$_['tab_voucher_history']           = 'История подарочных сертификатов';

// Error
$_['error_upload_1']                = 'Внимание: Размер загружаемого файла превышает максимальный размер, указанный в php.ini!';
$_['error_upload_2']                = 'Внимание: Размер загружаемого файла превышает MAX_FILE_SIZE, указанный в настройках магазина!';
$_['error_upload_3']                = 'Внимание: Файл загружен не полностью!';
$_['error_upload_4']                = 'Внимание: Файл не загружен!';
$_['error_upload_6']                = 'Внимание: Не найдена временная папка!';
$_['error_upload_7']                = 'Внимание: Не удалось записать файл на диск!';
$_['error_upload_8']                = 'Внимание: Загрузка файла остановлена!';
