...
$_['entry_manufacturer']     = 'Производитель:<br /><span class="help">(Для автозаполнения введите знак %)</span>';
$_['entry_main_category']    = 'Главная категория:';
$_['entry_date_available']   = 'Дата поступления:';
$_['entry_quantity']         = 'Количество:';
$_['entry_minimum']          = 'Минимальное количество:<br/><span class="help">Количество товара для минимального заказа</span>';
...
$_['entry_category']         = 'Показывать в категориях:<br /><span class="help">(Для автозаполнения введите знак %)</span>';
$_['entry_filter']           = 'Фильтр:<br /><span class="help">(Для автозаполнения введите знак %)</span>';
$_['entry_download']         = 'Загрузки:<br /><span class="help">(Для автозаполнения введите знак %)</span>';
$_['entry_related']          = 'Рекомендуемые товары:<br /><span class="help">(Для автозаполнения введите знак %)</span>';
