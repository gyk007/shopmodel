...
class ControllerCommonFileManager extends Controller {
	...
	public function index() {
		...
		$this->data['button_multiupload'] = $this->language->get('button_multiupload');
		$this->data['button_refresh'] = $this->language->get('button_refresh');
		$this->data['button_refresh'] = $this->language->get('button_refresh'); 
		$this->data['button_submit'] = $this->language->get('button_submit'); 
		$this->data['button_insert'] = $this->language->get('button_insert');
		
		$this->data['expand_tree'] = $this->language->get('expand_tree');
		$this->data['collapse_tree'] = $this->language->get('collapse_tree');
		$this->data['list_view'] = $this->language->get('list_view');
		$this->data['thumb_view'] = $this->language->get('thumb_view');
		...
		$this->data['text_warning_conf'] = $this->language->get('text_warning_conf');
		$this->data['title_folder_delete'] = $this->language->get('title_folder_delete');
		$this->data['title_file_delete'] = $this->language->get('title_file_delete');
		$this->data['file_delete'] = $this->language->get('file_delete');
		$this->data['no_image_selected'] = $this->language->get('no_image_selected');
		$this->data['title_no_image_selected'] = $this->language->get('title_no_image_selected');
		$this->data['text_ok'] = $this->language->get('text_ok');
		$this->data['multiple_upload'] = $this->language->get('multiple_upload');
		$this->data['allowed_files'] = $this->language->get('allowed_files');
		$this->data['upload_one_file'] = $this->language->get('upload_one_file');
		$this->data['no_files_found'] = $this->language->get('no_files_found');
		$this->data['files_found'] = $this->language->get('files_found');
		$this->data['files_count'] = $this->language->get('files_count');
