	...
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['length_class'] = $this->url->link('localisation/length_class', 'token=' . $this->session->data['token'], 'SSL');
             $this->data['myimport'] = $this->url->link('module/myiport', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['zone'] = $this->url->link('localisation/zone', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['ok_export'] = $this->url->link('extension/ok_export', 'token=' . $this->session->data['token'], 'SSL');
            $this->language->load('extension/ok_export_header');
            $this->data['text_ok_export'] = $this->language->get('text_ok_export');
