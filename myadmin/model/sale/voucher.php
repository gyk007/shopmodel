...
class ModelSaleVoucher extends Model {
	...
	public function changeStatus($voucher_id, $column_name, $value){
		$this->db->query("UPDATE " . DB_PREFIX . "voucher SET " . $column_name . " = '" . (int)$value . "' WHERE voucher_id = '" . (int)$voucher_id . "'");
	}
}
?>