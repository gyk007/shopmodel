...
class ModelSaleCustomer extends Model {
	...
	public function changeStatus($customer_id, $column_name, $value){
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET " . $column_name . " = '" . (int)$value . "' WHERE customer_id = '" . (int)$customer_id . "'");
	}
}
?>