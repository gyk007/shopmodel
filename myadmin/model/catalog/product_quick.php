...
class ModelCatalogProductQuick extends Model {
	public function addProduct($data) {
        ...
        $priceOpt = (float)$data['price'] - 15;
        $priceClient = (float)$data['price'] -  5;
        
		$this->db->query("INSERT INTO " . DB_PREFIX . "product_special SET product_id = '" . (int)$product_id . "', customer_group_id = 5, priority = 1 , price = " . $priceClient);
        $this->db->query("INSERT INTO " . DB_PREFIX . "product_special SET product_id = '" . (int)$product_id . "', customer_group_id = 3, priority = 1 , price = " . $priceOpt);
	...
	public function getProducts($data = array()) {
		if ($data) {
            ...
            if (!empty($data['filter_manufacturer'])) {
				$sql .= " AND manufacturer_id = ".(int)$data['filter_manufacturer'] ;			
			}       
	...
	public function getProductManufacturer($product_id) {
		...
		$query = $this->db->query("SELECT name FROM " . DB_PREFIX . "manufacturer WHERE manufacturer_id = (SELECT manufacturer_id FROM " . DB_PREFIX . "product WHERE product_id =  " . (int)$product_id . ") ");
