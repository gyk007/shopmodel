...
class ModelLocalisationLanguage extends Model {
	...
	public function changeStatus($language_id, $column_name, $value){
		$this->db->query("UPDATE " . DB_PREFIX . "language SET " . $column_name . " = '" . (int)$value . "' WHERE language_id = '" . (int)$language_id . "'");
