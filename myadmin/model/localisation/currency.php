...
class ModelLocalisationCurrency extends Model {
	...
	public function changeStatus($currency_id, $column_name, $value){
		$this->db->query("UPDATE " . DB_PREFIX . "currency SET " . $column_name . " = '" . (int)$value . "' WHERE currency_id = '" . (int)$currency_id . "'");
